<template>
  <div class="ui container">
    ...
    <div class="ui top attached tabular menu">
      <a class="item" style="color: #1E2C99; font-weight:bold;"  :class="{ active: selectedTab === 'posts' }" @click="selectTab('posts')">貼文</a>
      <a class="item" style="color: #1E2C99; font-weight:bold;" :class="{ active: selectedTab === 'friends' }" @click="selectTab('friends')">朋友</a>
