      ...
      <div v-if="type === 'followers'">
        ...
        <div class="row">
          <template v-if="loading">
            <SkeletonUser v-for="n in 1" :key="n" />
          </template>
          <template v-else>
            <div class="username-container" v-for="follower in followers" :key="follower.userId">
              <div class="profile-container">
                ...
                <div class="profile-description">
                  <a href="#" class="user-title" @click="handleUserClick(follower)">
                    {{ follower.userFirstName }} {{ follower.userLastName }}
                  </a>
          ...
          <template v-else>
            <div class="username-container" v-for="following in followings" :key="following.userId">
              <div class="profile-container">
                ...
                <div class="profile-description">
                  <a href="#" class="user-title" @click="handleUserClick(following)">
