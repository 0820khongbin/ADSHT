<template>
    <h1>{{ route.query.name }}的會員項目</h1>
    <div class="container group">
        <FindSubsCompo2 v-for="product in products" :key="product.ServiceId" :productA="product" showbtn="findSubs"
...
function callFind() {
    ...
    //     "order": "price",
    // };
    axiosapi.defaults.headers['session-id'] = route.query.id;
