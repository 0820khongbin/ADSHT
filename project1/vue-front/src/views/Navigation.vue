  ...
  <nav :class="['navbar', 'navbar-expand-lg', 'bg-body-tertiary', 'fixed-top']" :data-bs-theme="darkMode ? 'dark' : null">
    <div class="container-fluid d-flex justify-content-center ">
      <RouterLink class="navbar-brand" to="/">
        <img src="/background/navLogo2.png" alt="Nav Logo" class="logo-large" />
      </RouterLink>
...
const applyBackgroundImage = () => {
  if (darkMode.value) {
    document.body.classList.add('dark-mode');
    document.body.style.backgroundImage = "url('/public/background/dark-theme.jpg')";
  } else {
    document.body.classList.remove('dark-mode');
    document.body.style.backgroundImage = "url('/public/pic2/5.jpg')";
  }
};
...
function startPolling() {
  ...
  pollingInterval.value = setInterval(getUnreadNotificationCount, 5000); // 每30秒輪詢一次
}
...
onMounted(() => {
  checkDarkMode();
  applyBackgroundImage();  // 根据当前模式应用背景图
