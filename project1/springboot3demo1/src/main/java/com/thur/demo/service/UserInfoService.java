...
public class UserInfoService {
    ...
    public UserInfo editUserInfoByJsonSave(User user, JSONObject data, HttpSession session) {
        UserInfo info = user.getUserinfo();
        try {
            if (data.has("birth") && !data.isNull("birth")) {
            ...
            if (data.has("selfContent") && !data.isNull("selfContent")) {
                info.setSelfContent(data.getString("selfContent"));
            }
            if (data.has("userFirstName") && !data.isNull("userFirstName")) {
                info.setUserFirstName(data.getString("userFirstName"));
            }
            if (data.has("userLastName") && !data.isNull("userLastName")) {
