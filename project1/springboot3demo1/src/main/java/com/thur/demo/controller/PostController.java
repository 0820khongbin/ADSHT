...
public class PostController {
    ...
    public String searchPostbyWord(@RequestBody String keyWord) {
        JSONObject response = new JSONObject();
        JSONArray items = new JSONArray();
        int page = new JSONObject(keyWord).getInt("page");
        System.out.println("page: " + page);
        List<Post> posts = postService.searchPostByWord(new JSONObject(keyWord).getString("sentence").split(" "),
                new JSONObject(keyWord).getInt("page"));
